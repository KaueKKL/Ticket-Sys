...
import { 
  ...
  ListItemText, Avatar, useMediaQuery, useTheme, Tooltip, Badge
} from '@mui/material';
import { 
  Menu as MenuIcon, 
...
const drawerWidth = 280; // Sidebar um pouco mais larga para elegância
...
const MainLayout = () => {
  ...
  const menuItems = [
    ...
    { text: 'Faturamento', icon: <BillingIcon />, path: '/billing' },
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%', bgcolor: '#ffffff' }}>
            ...
            <ListItem key={item.text} disablePadding sx={{ mb: 1 }}>
              <ListItemButton
                ...
                sx={{
                  ...
                  py: 1.5,
                  transition: 'all 0.2s',
                  // Estilo Ativo: Fundo azul bem clarinho + Texto Azul Forte + Barra lateral
                  '&.Mui-selected': { 
      ...
      <Box sx={{ p: 2 }}>
        ...
        >
          ...
          <Typography fontWeight="600">Sair</Typography>
        </ListItemButton>
    ...
    <Box sx={{ display: 'flex', minHeight: '100vh', bgcolor: 'background.default' }}>
      ...
      <AppBar 
        ...
        sx={{ 
          ...
          bgcolor: 'rgba(255,255,255,0.8)', // Efeito vidro
