                ...
                <CardContent sx={{ p: 2, '&:last-child': { pb: 2 } }}>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      ...
                      <Typography variant="caption" fontWeight="500">{t.technician.split(' ')[0]}</Typography>
                    </Box>
                    <Box>
                  ...
                  <Paper variant="outlined" sx={{ p: 2, bgcolor: '#f8fafc' }}>
                    <FormControl fullWidth sx={{ mb: 2 }}>
                      ...
                      <Select value={formData.status} label="Status" onChange={(e) => setFormData({ ...formData, status: e.target.value })}>
                        ...
                        <MenuItem value="Aguardando Cliente"><PauseCircle color="warning" sx={{ mr: 1 }}/> Aguardando Cliente</MenuItem>
                        <MenuItem value="Finalizado"><CheckCircle color="action" sx={{ mr: 1 }}/> Finalizado</MenuItem>
                      </Select>
                    </FormControl>
